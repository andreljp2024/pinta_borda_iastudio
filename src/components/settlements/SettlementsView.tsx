    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-6">
        ...
        {userRole === 'ADMIN' && (
          <div className="w-full sm:w-64">
            <select
              ...
              className="w-full p-2.5 text-xs bg-white rounded-xl border border-[#fbcfe8] text-[#380c25] focus:outline-none font-mono-craft"
            >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        <div className="bg-[#ffffff] rounded-2xl p-5 border border-[#fbcfe8] shadow-2xs">
          ...
          <div className="text-base font-display font-medium text-[#380c25]">
            Auditabilidade por Venda
          </div>
          <span className="text-[11px] text-[#863b63] mt-1 block font-light">
            ...
            <table className="w-full text-left text-xs">
              ...
              <tbody className="divide-y divide-[#fff0f5] text-[#380c25]">
                {visibleSettlements.map((st) => {
                  ...
                  return (
                    <tr key={st.id} className="hover:bg-[#fff0f5]/40 transition-colors">
                ...
                {visibleMonthlyFees.map((fee) => {
                  ...
                  return (
                    <tr key={fee.id} className="hover:bg-[#fff0f5]/40 transition-colors">
                      <td className="py-3.5 px-4 font-bold font-display text-sm text-[#380c25]">{fee.monthReference}</td>
                      <td className="py-3.5 px-4 font-medium text-[#380c25]">{fee.partnerName}</td>
