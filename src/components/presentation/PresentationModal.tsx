...
export const PresentationModal: React.FC<PresentationModalProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-[#172521]/80 backdrop-blur-sm p-3 sm:p-6 overflow-y-auto">
      <div className="bg-[#f8f5ef] rounded-3xl max-w-5xl w-full shadow-2xl border border-[#ded6ca] overflow-hidden flex flex-col my-auto max-h-[92vh]">
        {/* Modal Topbar */}
        <div className="px-6 py-4 bg-[#fffaf2] border-b border-[#ded6ca] flex items-center justify-between shrink-0">
          <div className="flex items-center gap-3">
            <div className="w-9 h-9 rounded-full bg-[#253a35] text-[#fffaf2] flex items-center justify-center font-display font-medium text-sm border border-[#38524a]">
              p b
            </div>
            <div>
              <span className="text-[10px] font-mono-craft text-[#824f3c] uppercase block">
                Dossiê & Apresentação Institucional
              </span>
              <h3 className="font-display font-medium text-[#253a35] text-sm sm:text-base">
          ...
          <div className="flex items-center gap-2">
            <span className="text-xs font-mono-craft text-[#7d8c83] hidden sm:inline-block">
              Capítulo {currentSlideIndex + 1} de {SLIDES.length}
            </span>
            <button
              onClick={onClose}
              className="w-8 h-8 rounded-full bg-[#ede5d8] hover:bg-[#ded6ca] text-[#253a35] flex items-center justify-center transition-colors cursor-pointer border border-[#ded6ca]"
            >
              <X className="w-4 h-4" />
            </button>
          </div>
        ...
        <div className="bg-[#ede5d8]/50 px-6 py-2 border-b border-[#ded6ca] flex items-center gap-1.5 overflow-x-auto text-xs shrink-0 no-scrollbar">
            ...
            <button
              ...
              className={`px-3.5 py-1.5 rounded-full whitespace-nowrap text-xs font-mono-craft transition-colors cursor-pointer ${
                index === currentSlideIndex
                  ...
                  : 'text-[#52615a] hover:bg-[#ede5d8] hover:text-[#253a35]'
              }`}
            >
        ...
        <div className="p-6 sm:p-8 overflow-y-auto flex-1 space-y-6">
          ...
          {currentSlide.id === 'capa' && (
            <div className="space-y-8 text-center max-w-3xl mx-auto py-6">
              <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#ede5d8] text-[#253a35] text-xs font-mono-craft border border-[#ded6ca]">
                <Sparkles className="w-3.5 h-3.5 text-[#b56f55]" />
                Conexão Criativa e Colaborativa @projetopintaebordaslz
              </div>

              <div className="space-y-3">
                <h1 className="font-display text-4xl sm:text-5xl font-medium text-[#253a35] leading-tight">
                  Projeto Social <br />
                  <span className="text-[#b56f55] italic">Pinta e Borda</span>
                </h1>
                <p className="font-display text-xl sm:text-2xl text-[#52615a] italic font-light">
                  "Levando a vida com arte e solidariedade!"
                </p>
              </div>

              <p className="text-sm sm:text-base text-[#52615a] leading-relaxed max-w-2xl mx-auto font-light">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-4 text-left">
                <div className="bg-[#fffaf2] p-5 rounded-2xl border border-[#ded6ca] shadow-2xs">
                  <div className="w-8 h-8 rounded-lg bg-[#ede5d8] text-[#824f3c] flex items-center justify-center font-bold mb-2">
                    <Heart className="w-4 h-4" />
                  </div>
                  <h4 className="font-medium font-display text-sm text-[#253a35]">Fundado em 2008</h4>
                  <p className="text-[11px] text-[#52615a] mt-1 font-light">Criado pela artista Keka (@ditodacor) com base no afeto e na cooperação feminina.</p>
                </div>

                <div className="bg-[#fffaf2] p-5 rounded-2xl border border-[#ded6ca] shadow-2xs">
                  <div className="w-8 h-8 rounded-lg bg-[#ede5d8] text-[#253a35] flex items-center justify-center font-bold mb-2">
                    <Store className="w-4 h-4" />
                  </div>
                  <h4 className="font-medium font-display text-sm text-[#253a35]">Loja no Shopping</h4>
                  <p className="text-[11px] text-[#52615a] mt-1 font-light">Rio Anil Shopping (Piso 2, em frente à Marisa) com vitrine e balcão coletivo.</p>
                </div>

                <div className="bg-[#fffaf2] p-5 rounded-2xl border border-[#ded6ca] shadow-2xs">
                  <div className="w-8 h-8 rounded-lg bg-[#ede5d8] text-[#3c6b54] flex items-center justify-center font-bold mb-2">
                    <HandHeart className="w-4 h-4" />
                  </div>
                  <h4 className="font-medium font-display text-sm text-[#253a35]">100% Autônomo</h4>
                  <p className="text-[11px] text-[#52615a] mt-1 font-light">Sem dependência partidária ou governamental, sustentado por união e economia real.</p>
                </div>
              </div>
            </div>
          )}
          ...
          {currentSlide.id === 'origem' && (
            <div className="space-y-6 max-w-3xl mx-auto">
              <div>
                <span className="text-xs font-mono-craft text-[#824f3c] uppercase">
                  {currentSlide.badge}
                </span>
                <h2 className="font-display text-2xl sm:text-3xl font-medium text-[#253a35] mt-1">
                  {currentSlide.title}
                </h2>
                <p className="text-xs sm:text-sm text-[#52615a] mt-1 font-light">{currentSlide.subtitle}</p>
              </div>

              <div className="bg-[#fffaf2] rounded-3xl p-6 sm:p-8 border border-[#ded6ca] shadow-2xs space-y-4 text-xs sm:text-sm text-[#52615a] leading-relaxed font-light">
                <p>
                  O <strong className="text-[#253a35] font-medium">Projeto Pinta e Borda</strong> é um coletivo autônomo formado por voluntárias, em sua grande maioria
                  <strong className="text-[#253a35] font-medium"> mulheres artesãs e pequenas empreendedoras</strong>.
                </p>
                <p>
                  Criado em <strong className="text-[#253a35] font-medium">2008 pela artista Keka (@ditodacor)</strong>, foi carinhosamente abraçado por amigas e ateliês parceiros
                ...
                <p>
                  A essência do projeto está firmemente pautada na solidariedade por meio do <strong className="text-[#253a35] font-medium">empreendedorismo social</strong>,
                  atuando como um acolhedor <strong className="text-[#253a35] font-medium">"guarda-chuva colaborativo"</strong> que capacita, fortalece e impulsiona pequenas marcas e ateliês.
                </p>

                <div className="p-4 bg-[#ede5d8]/70 rounded-2xl border border-[#ded6ca] text-[#253a35]">
                  <div className="font-mono-craft text-xs uppercase flex items-center gap-1.5 mb-1 text-[#824f3c]">
                    <CheckCircle2 className="w-4 h-4 text-[#824f3c]" />
                    Independência & Autonomia
                  </div>
                  <p className="text-xs leading-relaxed font-light text-[#52615a]">
          ...
          {currentSlide.id === 'impacto-social' && (
            <div className="space-y-6 max-w-3xl mx-auto">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <div className="bg-[#fffaf2] p-5 rounded-2xl border border-[#ded6ca] shadow-2xs space-y-2">
                  <div className="w-10 h-10 rounded-xl bg-[#ede5d8] text-[#824f3c] flex items-center justify-center font-bold">
                    🥣
                  </div>
                  <h3 className="font-display font-medium text-base text-[#253a35]">Sopões nos Hospitais</h3>
                ...
                <div className="bg-[#fffaf2] p-5 rounded-2xl border border-[#ded6ca] shadow-2xs space-y-2">
                  <div className="w-10 h-10 rounded-xl bg-[#ede5d8] text-[#253a35] flex items-center justify-center font-bold">
                    🎨
                  </div>
                  <h3 className="font-display font-medium text-base text-[#253a35]">Recreação Infantil</h3>
                  <p className="text-xs text-[#52615a] leading-relaxed font-light">
                ...
                <div className="bg-[#fffaf2] p-5 rounded-2xl border border-[#ded6ca] shadow-2xs space-y-2">
                  <div className="w-10 h-10 rounded-xl bg-[#ede5d8] text-[#3c6b54] flex items-center justify-center font-bold">
                    🧵
                  </div>
                  <h3 className="font-display font-medium text-base text-[#253a35]">Oficinas Formativas</h3>
                  <p className="text-xs text-[#52615a] leading-relaxed font-light">
              ...
              <div className="bg-[#253a35] text-[#fffaf2] p-6 rounded-3xl border border-[#38524a] space-y-2 shadow-md">
                <h4 className="font-display text-lg text-[#d4ba84]">
          ...
          {currentSlide.id === 'loja-colaborativa' && (
            <div className="space-y-6 max-w-3xl mx-auto">
              ...
              <div className="bg-[#fffaf2] rounded-3xl p-6 sm:p-8 border border-[#ded6ca] shadow-2xs space-y-4">
                <div className="flex items-start gap-4">
                  <div className="w-12 h-12 rounded-2xl bg-[#253a35] text-[#fffaf2] flex items-center justify-center shrink-0 border border-[#38524a]">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-[#52615a] mt-1 font-light">
                      Localização nobre: <strong className="text-[#253a35] font-medium">2º Piso, próximo à Praça de Alimentação e em frente à Loja Marisa</strong>.
                    </p>
                  </div>
                </div>

                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-2 text-xs">
                  <div className="p-4 bg-[#f8f5ef] rounded-2xl border border-[#ded6ca]">
                    <h4 className="font-display font-medium text-base text-[#253a35] mb-1">Como Funciona a Parceria?</h4>
                    <p className="text-[#52615a] leading-relaxed font-light">
                      As marcas interessadas em contribuir com o projeto devem se cadastrar inicialmente como <strong className="text-[#253a35]">voluntárias</strong>,
                      vivenciando de perto as etapas das ações sociais antes de integrar a vitrine física no shopping.
                    </p>
                  </div>

                  <div className="p-4 bg-[#f8f5ef] rounded-2xl border border-[#ded6ca]">
                    <h4 className="font-display font-medium text-base text-[#253a35] mb-1">Incentivo ao Empreendedorismo</h4>
                    <p className="text-[#52615a] leading-relaxed font-light">
          ...
          {currentSlide.id === 'marcas' && (
            <div className="space-y-6">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
                ...
                <span className="text-xs font-mono-craft px-3 py-1 bg-[#ede5d8] text-[#253a35] rounded-full self-start sm:self-auto border border-[#ded6ca]">
                  14 Ateliês Oficiais
                </span>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 max-h-[50vh] overflow-y-auto pr-1">
                {BRANDS.map((brand) => (
                  <div
                    key={brand.name}
                    className="bg-[#fffaf2] rounded-3xl p-5 border border-[#ded6ca] hover:border-[#b56f55] hover:shadow-md transition-all flex flex-col justify-between"
                  >
                    <div>
                      <div className="flex items-center justify-between mb-2">
                        <span className="text-[10px] font-mono-craft uppercase px-2.5 py-0.5 rounded-full bg-[#ede5d8] text-[#824f3c] border border-[#ded6ca]">
                          {brand.tag}
                        </span>
                        <span className="text-[10px] font-mono-craft text-[#7d8c83]">{brand.category}</span>
                      </div>

                      <h4 className="font-display font-medium text-lg text-[#253a35]">
                        {brand.name}
                      </h4>
                      <p className="text-xs text-[#7d8c83] font-mono-craft mb-2">{brand.founder}</p>

                      <p className="text-xs text-[#52615a] leading-relaxed mb-4 font-light">
                        {brand.desc}
                      </p>
                    </div>
                    ...
                    <div className="pt-3 border-t border-[#ded6ca] flex items-center justify-between text-xs">
                      <a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        className="text-[#253a35] hover:text-[#b56f55] font-mono-craft flex items-center gap-1"
                      >
                        <Instagram className="w-3.5 h-3.5 text-[#b56f55]" />
                        {brand.instagram}
                      </a>
          ...
          {currentSlide.id === 'b2b-parcerias' && (
            <div className="space-y-6 max-w-3xl mx-auto">
              ...
              <div className="bg-[#253a35] text-[#fffaf2] rounded-3xl p-6 sm:p-8 border border-[#38524a] shadow-md space-y-4">
                <span className="text-xs font-mono-craft text-[#d4ba84] uppercase">
                  Chamada para Empreendedores e Gestores
                </span>
                <h3 className="font-display text-2xl sm:text-3xl font-medium text-[#fffaf2] leading-snug">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-xs">
                <div className="bg-[#fffaf2] p-5 rounded-2xl border border-[#ded6ca] shadow-2xs space-y-2">
                  <div className="w-8 h-8 rounded-lg bg-[#ede5d8] text-[#253a35] flex items-center justify-center font-bold">
                    <Building2 className="w-4 h-4" />
                  </div>
                  <h4 className="font-display font-medium text-base text-[#253a35]">Ilhas em Shoppings & Hotéis</h4>
                  <p className="text-[#52615a] font-light">Pop-up stores organizadas com mix curado de artesanato maranhense e presença das criadoras.</p>
                </div>

                <div className="bg-[#fffaf2] p-5 rounded-2xl border border-[#ded6ca] shadow-2xs space-y-2">
                  <div className="w-8 h-8 rounded-lg bg-[#ede5d8] text-[#824f3c] flex items-center justify-center font-bold">
                    <Gift className="w-4 h-4" />
                  </div>
                  <h4 className="font-display font-medium text-base text-[#253a35]">Brindes Afetivos ESG</h4>
                  <p className="text-[#52615a] font-light">Presentes de fim de ano e kits corporativos com produtos naturais, cerâmica e azulejaria com causa real.</p>
                </div>

                <div className="bg-[#fffaf2] p-5 rounded-2xl border border-[#ded6ca] shadow-2xs space-y-2">
                  <div className="w-8 h-8 rounded-lg bg-[#ede5d8] text-[#3c6b54] flex items-center justify-center font-bold">
                    <Calendar className="w-4 h-4" />
                  </div>
                  <h4 className="font-display font-medium text-base text-[#253a35]">Feiras & Convenções</h4>
                  <p className="text-[#52615a] font-light">Estandes criativos em congressos e eventos culturais, levando a identidade autêntica do Maranhão.</p>
                </div>
              </div>
            </div>
          )}
          ...
          {currentSlide.id === 'contato' && (
            <div className="space-y-6 max-w-3xl mx-auto">
              ...
              <div className="bg-[#fffaf2] rounded-3xl p-6 sm:p-8 border border-[#ded6ca] shadow-2xs space-y-6">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  <div className="space-y-4">
                    ...
                    <div className="space-y-3 text-xs">
                      <div className="flex items-center gap-3 text-[#52615a]">
                        <div className="w-8 h-8 rounded-lg bg-[#ede5d8] text-[#253a35] flex items-center justify-center shrink-0 border border-[#ded6ca]">
                          <Phone className="w-4 h-4" />
                        </div>
                        <div>
                          <div className="font-medium text-[#253a35]">Telefone / WhatsApp</div>
                          <a href="https://wa.me/5598988289123" target="_blank" rel="noreferrer" className="text-[#b56f55] hover:underline font-mono-craft">
                      ...
                      <div className="flex items-center gap-3 text-[#52615a]">
                        ...
                        <div>
                          <div className="font-medium text-[#253a35]">E-mail Oficial</div>
                          <a href="mailto:projetopintaebordaslz@gmail.com" className="text-[#52615a] hover:underline font-mono-craft">
                      ...
                      <div className="flex items-center gap-3 text-[#52615a]">
                        <div className="w-8 h-8 rounded-lg bg-[#ede5d8] text-[#824f3c] flex items-center justify-center shrink-0 border border-[#ded6ca]">
                          <Instagram className="w-4 h-4" />
                        </div>
                        <div>
                          <div className="font-medium text-[#253a35]">Instagram</div>
                          <a href="https://instagram.com/projetopintaebordaslz" target="_blank" rel="noreferrer" className="text-[#b56f55] hover:underline font-mono-craft">
                  ...
                  <div className="space-y-4 sm:border-l sm:border-[#ded6ca] sm:pl-6">
                    <h3 className="font-display font-medium text-xl text-[#253a35]">
                      Ponto Físico no Shopping
                    </h3>

                    <div className="flex items-start gap-3 text-xs text-[#52615a]">
                      <div className="w-8 h-8 rounded-lg bg-[#ede5d8] text-[#253a35] flex items-center justify-center shrink-0 border border-[#ded6ca]">
                        <MapPin className="w-4 h-4" />
                      </div>
                      <div className="leading-relaxed font-light">
                        <div className="font-medium text-[#253a35]">Rio Anil Shopping</div>
                        <p className="text-[#52615a] mt-0.5">
                          2º Piso, Próximo à Praça de Alimentação e em frente à Loja Marisa.
                        </p>
                        <p className="text-[#7d8c83] font-mono-craft mt-1">São Luís / MA</p>
                      </div>
                    </div>
        ...
        <div className="px-6 py-4 bg-[#fffaf2] border-t border-[#ded6ca] flex items-center justify-between shrink-0">
          <button
            onClick={handlePrev}
            disabled={currentSlideIndex === 0}
            className={`px-4 py-2 rounded-full text-xs font-mono-craft transition-colors flex items-center gap-1.5 cursor-pointer ${
              currentSlideIndex === 0
                ? 'opacity-40 cursor-not-allowed text-[#7d8c83] bg-[#ede5d8]'
                : 'bg-[#ede5d8] hover:bg-[#ded6ca] text-[#253a35]'
            }`}
          >
            ...
            {SLIDES.map((_, idx) => (
              <span
                ...
                className={`h-2 rounded-full transition-all ${
                  idx === currentSlideIndex ? 'w-6 bg-[#253a35]' : 'w-2 bg-[#ded6ca]'
                }`}
              />
            ))}
          </div>
